                        ...
                        <div id="exam-psd" class="col s12">
                            <br>
                                <table class="responsive-table centered striped">
                                    <thead>
                                        <tr class="courses">
                                            <th data-field="full_name" style="width:250px; font-size:16px;">Sub-Course</th>
                                            <th data-field="upload" style="width:250px;font-size:16px;">Upload Date</th>
                                            <th data-field="desc" style="width: 400px;font-size:16px;">Description</th> {{--Baru--}}
                                              ...
                                              <td>
                                                ...
                                                <div id="delete{{$exam->id}}" class="modal" style="width: 20%" >
                                                  ...
                                                  {{--  {!! Form::open(array(['method' => 'DELETE','route' => ['course.destroy', $exam->id],'style'=>'display:inline'])) !!} --}}
                                                    {{ Form::open(array('url' => '/manage/exam/delete/'.$course->id,'style'=>'display:inline')) }}
