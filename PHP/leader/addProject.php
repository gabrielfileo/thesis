    ...
    <div id="wrapper" class="op">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="/TCID/pages/leader/listProject.php"><i class="fa fa-list fa-fw"></i> List Project</a>
                        </li>
                        <li>
                            <a href="/TCID/pages/admin/addProject.php"><i class="fa fa-plus-circle fa-fw"></i> Add Project</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <div id="page-wrapper">
          ...
          <div class="panel panel-default">
            ...
            <div class="row">
            <div class="col-lg-6">
              <form role="form" action="/TCID/pages/leader/doInsert.php" method="post">
                  <div class="form-group">
                      <label>Project Name</label>
                      <input class="form-control" name="namePro" placeholder="Project Name">
                  </div>
                  <div class="form-group">
                      <label>Project Code</label>
                      <input class="form-control" name="codePro" placeholder="Project Code">
                  </div>
                  <div class="form-group">
                      <label>Total Project</label>
                      <input class="form-control" name="totalPro" placeholder="Total Project">
                  </div>
                  <div class="form-group">
                      <label>Deadline</label>
                      <input type="date" class="form-control" name="deadPro" placeholder="Deadline">
                  </div>
                  <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          while($row = mysql_fetch_assoc($result))
													{
														?>
                              <input type="checkbox"><?=$row['nama']?><br>
                              <?php
                            $i++;
                          }
                        ?>
