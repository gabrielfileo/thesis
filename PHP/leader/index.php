                    ...
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
                            <div class="input-group custom-search-form">
                                <input type="text" class="form-control" placeholder="Search Project ID">
                        ...
                        <li>
                            <a href="addProject.php"><i class="fa fa-check-square fa-fw"></i> Add Project</a>
                        </li>
                        <li>
                            <a href="index.html"><i class="fa fa-list fa-fw"></i> Project List</a>
                        </li>
                        <li>
                            <a href="doneProject.html"><i class="fa fa-check-square fa-fw"></i> Complete Project</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
